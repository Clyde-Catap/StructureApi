    ...
    if Beam.beam_type == "simply_supported":
        ...
        for force in Beam.forces:
            ...
            if force.force_type == "single":
                singleForce = SinglePointForce(magnitude=force.force_parts.magnitude,
                                               distance=force.force_parts.distance)
                singleForceReactions = simplySupportedBeam.singlePointLoadReactions(singleForce, Beam.total_beam_length)
            ...
            if force.force_type == "uniform":
                ...
                uniformForceReactions = simplySupportedBeam.uniformLoadReactions(uniformForce, Beam.total_beam_length)
            ...
            if force.force_type == "triangle":
                triangleForce = TriangleLoadForce(load_magnitude=force.force_parts.magnitude,
                                                  distance_of_max_to_origin=force.force_parts.distance_of_max_to_origin,
                                                  distance_of_min_to_origin=force.force_parts.distance_of_min_to_origin,
                                                  length_of_load=force.force_parts.length_of_load)
                triangleForceReactions = simplySupportedBeam.triangleLoadReactions(triangleForce, Beam.total_beam_length)
            ...
            if force.force_type == "trapezoid":
                trapezoidForce = TrapezoidalLoadForce(load_magnitude=force.force_parts.magnitude,
                                                      distance_of_min_lower_load_to_origin=force.force_parts.distance_of_min_lower_load_to_origin,
                                                      distance_of_max_lower_load_to_origin=force.force_parts.distance_of_max_lower_load_to_origin,
                                                      distance_of_max_upper_load_to_origin=force.force_parts.distance_of_max_upper_load_to_origin,
                                                      distance_of_min_upper_load_to_origin=force.force_parts.distance_of_min_upper_load_to_origin)
                trapezoidForceReactions = simplySupportedBeam.trapezoidalLoadReactions(trapezoidForce, Beam.total_beam_length)
